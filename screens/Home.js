...
export default class HomeScreen extends Component {
  constructor(props) {
    ...
    this.state={
      movieDetails: {},
      ngrok_url:"https://bd33-179-96-207-72.ngrok.io/"
    }
  }
...
notwatched=()=>{
  const url=this.state.ngrok_url+"did_notwatch"
  axios
    .get(url)
    .then(()=>{
      this.getmovie()
  ...
  render() {
    ...
    if (movieDetails.original_title){
      const {original_title,release_date,duration,rating}=movieDetails
      return (
            ...
            <View style={styles.subContainer}>
              <View style={{flex:0.15}}>
                ...
                <View style={styles.detailsContainer}>
                  ...
                  <Text style={styles.subtitle}>{release_date.split("-")[0]}|{duration}min</Text>
                </View>
              </View>
              <View style={styles.ratingContainer}>
                {/*Adicione os componentes para mostrar a classificação do filme abaixo*/}
                  <Star style={styles.starStyle}score={rating}/>
              </View>
              <View style={styles.iconButtonContainer}>
                ...
                <TouchableOpacity onPress={this.notWatched}>
                  <Image style={style.iconImage} source={require("../assets/didNotWatch.png")}/>
                </TouchableOpacity>
              </View>
            </View>
          </ImageBackground>
